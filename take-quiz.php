...
// Fetch categories
$sql = "SELECT DISTINCT category FROM tbl_quiz";
            ...
            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                <div class="feature-1 border">
                    ...
                    <div class="feature-1-content">
                        ...
                        <p><a href="take-quiz-question.php?category=<?php echo urlencode($category); ?>" class="btn btn-primary px-4 rounded-0">Take Quiz</a></p>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
