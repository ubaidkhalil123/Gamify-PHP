...
$stmt = $connection->prepare('SELECT xp, level, badge FROM users WHERE user_id = ?');
if (!$stmt) {
...
// Fetch additional user data from academic_register
$query = '
    SELECT ar.email, ar.streak, ar.last_streak_update
    FROM academic_register ar
    WHERE ar.id = ?
';
...
$result = $stmt->get_result();
$academic_user = $result->fetch_assoc();

$stmt->close();
$connection->close();

if (!$academic_user) {
    die('User data not found in academic_register.');
}

// Assign values to variables
$email = $academic_user['email'];
$xp = $user['xp'];
$level = $user['level'];
$badge = $user['badge'];
$streak = $academic_user['streak'];
$last_streak_update = $academic_user['last_streak_update'];
?>
          ...
          <div class="col-lg-6 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                <h2>Finalize your Goals</h2>
                <p>Show Your Interest and Select Your Related  Course </p>
                <p><a href="#" class="btn btn-primary px-4 rounded-0">Lets Go</a></p>
              </div>
            </div>
          </div>
           ...
           <div class="col-lg-6 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p>Show Your Interest and Select Your Related  Course </p>
                <p><a href="#" class="btn btn-primary px-4 rounded-0">Continue Learning </a></p>
              </div>
            </div>
          </div>

           <div class="mt-5 col-lg-6 col-md-6 mb-4 mb-lg-0">
   <div class="feature-1 border">
    <div class="feature-1-content">
        ...
        <div class="profile-footer">
            <p><i class="fas fa-star"></i> XP: <span class="bold-text"><?php echo htmlspecialchars($xp); ?></span></p>
            <p><i class="fas fa-level-up-alt"></i> Level: <span class="bold-text"><?php echo htmlspecialchars($level); ?></span></p>
            <p><i class="fas fa-trophy"></i> Badge: <span class="bold-text"><?php echo htmlspecialchars($badge); ?></span></p>
            <p><i class="fas fa-calendar-check"></i> Streak: <span class="bold-text"><?php echo htmlspecialchars($streak); ?></span> day(s)</p>
        </div>
    </div>
</div>
</div>
