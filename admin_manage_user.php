...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
          ...
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li>
                  <a href="admin_manage_user.php" class="nav-link text-left">Manage Users</a>
                </li>
                 <!-- <li> 
 ...
 <div class="site-section">
  <div class="container">
    <h2 class="mb-4">Registerd Users</h2>
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="admin_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm btn-action">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="admin_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm btn-action">
