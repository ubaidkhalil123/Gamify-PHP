...
if (isset($_POST['adminlogin'])) {
    ...
    $pass = mysqli_real_escape_string($connection, $_POST['adminpassword']);
                ...
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" name="adminemail" id="email" class="form-control form-control-lg">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="pword">Password</label>
                            <input type="password" name="adminpassword" id="pword" class="form-control form-control-lg">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <input type="submit" name="adminlogin" value="Login" class="btn btn-primary btn-lg px-5">
                        </div>
                    </div>
                  </form>
                </div>
